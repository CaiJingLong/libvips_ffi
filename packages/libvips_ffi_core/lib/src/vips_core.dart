...
VipsBindings get vipsBindings {
  if (_vipsBindings == null) {
    throw StateError(
      'libvips not initialized. Call initVipsSystem(), initVipsWithLoader(), '
...
///
/// Initialize libvips using system library (desktop).
///
/// This will search for libvips in common system paths:
/// - macOS: /opt/homebrew/lib, /usr/local/lib
/// - Linux: system library path
/// - Windows: system PATH
///
/// Throws [StateError] if libvips is not found.
...
/// 使用自定义加载器初始化 libvips
///
/// Initialize libvips with a custom loader.
void initVipsWithLoader(
...
///
/// Initialize libvips with a DynamicLibrary directly.
void initVipsWithLibrary(
