...
/// Windows 专用主页（已在 main 中初始化，不再重复初始化）
...
class _WindowsHomePageState extends State<WindowsHomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('libvips Windows Example'),
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Text(
                      'This example demonstrates the libvips_ffi plugin on Windows, '
                      'using pre-compiled DLLs for image processing.\n\n'
